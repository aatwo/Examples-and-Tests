...
class MainWindow : public SDLEventDelegate
{
    ...
    private:
        ...
        struct ShapeDef
        {
            ...
            // polygon only stuff
            std::vector<b2Vec2> vertices; // these should be relative to the shapes center, not the body. The offset from the body center will be computed using relativeCenter.
        };
